...
const styles = StyleSheet.create({
  ...
  bottom: { position: "absolute", left: 14, right: 14, borderRadius: 28, backgroundColor: "#fff", borderWidth: 1, borderColor: BORDER, padding: 14, gap: 12, shadowColor: "#13285f", shadowOpacity: 0.18, shadowRadius: 28, shadowOffset: { width: 0, height: 14 }, elevation: 16 }, bottomTop: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10 }, bottomCopy: { flex: 1, minWidth: 0 }, bottomLabel: { color: MUTED, fontSize: 11, fontWeight: "900", letterSpacing: 1.3 }, bottomAmount: { color: TEXT, fontSize: 24, fontWeight: "900", marginTop: 4, flexShrink: 1 }, details: { color: ACCENT, fontSize: 12, fontWeight: "900" }, checkout: { minHeight: 58, borderRadius: 18, backgroundColor: ACCENT, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9 }, checkoutOff: { backgroundColor: "#cfd4df" }, checkoutText: { color: "#fff", fontSize: 15, fontWeight: "900", flexShrink: 1, textAlign: "center" },
});
