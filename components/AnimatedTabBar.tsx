...
function TabBarItem({
  ...
  const animatedStyle = useAnimatedStyle(() => {
    return {
      ...
      shadowOpacity: isFloating ? 0 : focusProgress.value * 0.14,
      shadowRadius: isFloating ? 0 : 8 * focusProgress.value,
      shadowColor: theme.glowColor,
      elevation: isFloating ? 0 : 3 * focusProgress.value,
    };
  });
