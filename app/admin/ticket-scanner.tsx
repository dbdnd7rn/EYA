...
const styles = StyleSheet.create({
  ...
  scanFrame: { ...StyleSheet.absoluteFill, margin: 46 },
  ...
  scanOverlay: { ...StyleSheet.absoluteFill, backgroundColor: "rgba(10,23,48,0.64)", alignItems: "center", justifyContent: "center", gap: 10 },
