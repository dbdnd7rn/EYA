  ...
  return (
    <PublicPageShell title="Contact us">
      <View style={{ gap: 12 }}>
        ...
        <Pressable onPress={() => Linking.openURL("mailto:hello.pamaketi@gmail.com")}>
          <Text style={{ color: "#0e2756", fontSize: 15, fontWeight: "700" }}>Email: hello.pamaketi@gmail.com</Text>
        </Pressable>
