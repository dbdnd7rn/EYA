-- Subscription activation and maintenance are internal payment/cron authority.
-- They must never be exposed as client-callable PostgREST RPCs.
...
-- Trigger functions are invoked by their trigger, not through /rest/v1/rpc.
