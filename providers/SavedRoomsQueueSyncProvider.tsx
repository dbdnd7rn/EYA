...
import { syncSavedRoomsQueue } from "@/lib/savedRoomsOffline";
import { useAuth } from "@/providers/AuthProvider";
import { useNetwork } from "@/providers/NetworkProvider";

export function SavedRoomsQueueSyncProvider({ children }: { children: React.ReactNode }) {
  const { user } = useAuth();
...
export default SavedRoomsQueueSyncProvider;
