...
CREATE TABLE payment_intents_v2 (
  ...
  method TEXT NOT NULL CHECK (method IN ('airtel_money', 'mpamba', 'bank_transfer', 'card')),
...
INSERT INTO payment_intents_v2 (
  ...
  metadata_json, provider_payload_json, checkout_url, failure_reason,
  paid_at, verified_at, fulfilled_at, created_at, updated_at
)
SELECT
  id, app_id, app_payment_id, app_user_id, purpose, provider, method,
  merchant_reference, provider_reference, expected_amount_mwk, paid_amount_mwk,
...
CREATE TABLE payment_webhook_events_v2 (
  id TEXT PRIMARY KEY,
  provider TEXT NOT NULL DEFAULT 'paychangu' CHECK (provider = 'paychangu'),
  event_key TEXT NOT NULL,
  payment_intent_id TEXT REFERENCES payment_intents_v2(id),
...
INSERT INTO payment_webhook_events_v2 (
...
CREATE TABLE payment_outbox_events_v2 (
  id TEXT PRIMARY KEY,
...
INSERT INTO payment_outbox_events_v2 (
...
ALTER TABLE payment_intents_v2 RENAME TO payment_intents;
ALTER TABLE payment_webhook_events_v2 RENAME TO payment_webhook_events;
ALTER TABLE payment_outbox_events_v2 RENAME TO payment_outbox_events;
